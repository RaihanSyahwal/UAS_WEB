...
<head>
    <meta charset="UTF-8">
    <title>RAIHANSYAHWAL UAS</title>
    <link href="style.css" rel="stylesheet" type="text/css" />
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-GLhlTQ8iRABdZLl6O3oVMWSktQOp6b7In1Zl3/Jr59b6EGGoI1aFkw7cmDA6j6gD" crossorigin="anonymous">

</head>
<body style="margin-top: 30px; background-color: #ffffff;">
    <div class="container" style="background-color: #e4492e; width: 250%; padding: 10px;">
        <br><br>
        <div class="head">
        <h1 align ="center" style="color: #7eeef3;">Checklist Toilet</h1>
